...
def carregar_dados(empresas):
    ...
    cotacoes_acao = dados_acao.history(period="max", start="2010-01-01", end="2024-07-01")
...
st.write("""
# App Preço de ações
O gráfico abaixo representa a evoluçao do preço das ações ao longo dos anos
""") 
...
# Filtro de acoes
lista_acoes = st.sidebar.multiselect("Escolha as ações pra visualizar", dados.columns)
if lista_acoes:
...
intervalo_data = st.sidebar.slider("Selecione o período", 
                                    ...
                                    step=timedelta(days=1)) #Opcional
...
Essa foi a performance de cada ativo do período selecionado:
